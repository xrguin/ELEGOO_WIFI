...
// DeviceDriverSet_IRrecv AppIRrecv; // IR disabled for UNO R4
/*f(x) int */
static boolean
...
void ApplicationFunctionSet::ApplicationFunctionSet_Init(void)
{
  ...
  // AppIRrecv.DeviceDriverSet_IRrecv_Init(); // IR disabled for UNO R4
...
{
  AppULTRASONIC.DeviceDriverSet_ULTRASONIC_Get((uint16_t*)&UltrasoundData_cm); //Ultrasonic data
  UltrasoundDetectionStatus = function_xxx(UltrasoundData_cm, 0, ObstacleDetection);
...
{
#if 0  // IR functionality disabled for Arduino UNO R4 WiFi
